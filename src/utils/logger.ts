      ...
      [
        ...
        },
        {
          ...
          style: css`
            ...
            background-size: contain;
            background-repeat: no-repeat;
            background-image: url('/subEditorLogo.png');
          `,
        },
      ],
      ...data
